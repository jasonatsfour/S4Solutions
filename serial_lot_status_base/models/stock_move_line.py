...
class StockMoveLine(models.Model):
    ...
    operation_type = fields.Selection([
        ('add', 'Add'),
        ('remove', 'Remove'),
        ('edit', 'Replace')], string='Type')
    installed_lot = fields.Many2many('stock.production.lot', 'stock_move_line_stock_production_rel', 'move_line_id',
                                     'lot_id', string="Installed Lot", related="lot_id.lot_ids")
